<template>
  <div>
    ...
    <div>
      <ul class="collection">
        <li v-for="task in tasks" :key="task.name" v-if="!task.is_done" v-bind:id="'row_task_' + task.id" class="collection-item">
    ...
    <div id="finished-tasks" class="display_none">
      <ul class="collection">
        <li v-for="task in tasks" :key="task.name" v-bind:id="'row_task_' + task.id" class="collection-item">
          <label v-bind:for="'task_' + task.id">
            <input type="checkbox" v-bind:id="'task_' + task.id" />
            <span>{{ task.name }}</span>
          </label>
